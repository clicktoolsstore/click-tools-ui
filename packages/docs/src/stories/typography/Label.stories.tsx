...
import { labelTypo, LabelProps } from '@click-tools-ui/react'
import { HTMLAttributes } from 'react'

type ComponentProps = HTMLAttributes<HTMLHeadingElement> & LabelProps
...
const meta: Meta<ComponentProps> = {
  ...
  render: ({ size, className, children, ...rest }) => {
    return (
      <h1 className={labelTypo({ size, className })} {...rest}>
        {children}
      </h1>
    )
  },
